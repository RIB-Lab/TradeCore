...
public enum Materials {
     ...
     * 石と丸石系
     */
    PRIMITIVESTONES(Set.of(Material.COBBLESTONE, Material.STONE, Material.COBBLESTONE_SLAB, Material.STONE_SLAB)),

    /**
     * 単純木材系
     */
    PRIMITIVEPLANKS(Set.of(Material.ACACIA_PLANKS, Material.BIRCH_PLANKS, Material.BAMBOO_PLANKS, Material.CHERRY_PLANKS, Material.CRIMSON_PLANKS,
            Material.JUNGLE_PLANKS, Material.MANGROVE_PLANKS, Material.OAK_PLANKS, Material.DARK_OAK_PLANKS, Material.SPRUCE_PLANKS)),

    /**
     * 買えたらまずいもの
     */
    BANNEDFROMSHOP(Set.of(Material.CRAFTING_TABLE, Material.FURNACE, Material.TORCH, Material.CHEST, Material.ENDER_CHEST, Material.TRAPPED_CHEST,
