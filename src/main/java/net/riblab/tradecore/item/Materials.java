...
public enum Materials {
     ...
     * 葉っぱ
     */
    LEAVES(Set.of(Material.ACACIA_LEAVES, Material.AZALEA_LEAVES, Material.BIRCH_LEAVES, Material.CHERRY_LEAVES, Material.DARK_OAK_LEAVES
     ...
     * 原木
     */
    LOGS(Set.of(Material.ACACIA_LOG, Material.BIRCH_LOG, Material.CHERRY_LOG, Material.JUNGLE_LOG, Material.DARK_OAK_LOG
            , Material.MANGROVE_LOG, Material.OAK_LOG, Material.SPRUCE_LOG)),

    /**
     * レイキャストを阻害しない通過ブロック
     */
    TRANSPARENT(Set.of(Material.WATER, Material.LAVA, Material.AIR)),

    /**
     * 土系
     */
    DIRTS(Set.of(Material.DIRT, Material.GRASS_BLOCK, Material.DIRT_PATH, Material.COARSE_DIRT, Material.ROOTED_DIRT, Material.PODZOL)),

    /**
     * 石と丸石系
     */
    PRIMITIVE_STONES(Set.of(Material.COBBLESTONE, Material.STONE, Material.COBBLESTONE_SLAB, Material.STONE_SLAB)),

    /**
     * 単純木材系
     */
    PRIMITIVE_PLANKS(Set.of(Material.ACACIA_PLANKS, Material.BIRCH_PLANKS, Material.BAMBOO_PLANKS, Material.CHERRY_PLANKS, Material.CRIMSON_PLANKS,
            Material.JUNGLE_PLANKS, Material.MANGROVE_PLANKS, Material.OAK_PLANKS, Material.DARK_OAK_PLANKS, Material.SPRUCE_PLANKS)),

    /**
     * 買えたらまずいもの
     */
    BANNED_FROM_SHOP(Set.of(Material.CRAFTING_TABLE, Material.FURNACE, Material.TORCH, Material.CHEST, Material.ENDER_CHEST, Material.TRAPPED_CHEST,
