...
public enum LootTables {
    GRASS(new LootTable(Set.of(Material.GRASS, Material.TALL_GRASS), IToolStatsModifier.ToolType.HAND, 0, Map.of(1f, "drygrass", 0.2f, "pebble"))),
    LEAVES(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("leaves").orElseThrow(), IToolStatsModifier.ToolType.AXE, 0, Map.of(0.2f, "stick"))),
    LEAVES2(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("leaves").orElseThrow(), IToolStatsModifier.ToolType.AXE, 1, Map.of(0.1f, "stick"))),
    LOGS(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("logs").orElseThrow(), IToolStatsModifier.ToolType.AXE, 1, Map.of(0.2f, "round_trunk", 0.4f, "bark", 0.8f, "twig"))),
    LOGS2(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("logs").orElseThrow(), IToolStatsModifier.ToolType.AXE, 2, Map.of(0.2f, "round_trunk"))),
    LOGS3(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("logs").orElseThrow(), IToolStatsModifier.ToolType.AXE, 3, Map.of(0.1f, "round_trunk"))),
    DIRTS(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("dirts").orElseThrow(), IToolStatsModifier.ToolType.SHOVEL, 0, Map.of(0.2f, "dust", 0.1f, "mud"))),
    DIRTS2(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("dirts").orElseThrow(), IToolStatsModifier.ToolType.SHOVEL, 1, Map.of(0.1f, "dust", 0.05f, "mud"))),
    PRIMITIVE_STONES(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("primitive_stones").orElseThrow(), IToolStatsModifier.ToolType.PICKAXE, 0, Map.of(0.2f, "widestone", 0.21f, "tallstone"))),
    PRIMITIVE_STONES2(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("primitive_stones").orElseThrow(), IToolStatsModifier.ToolType.PICKAXE, 1, Map.of(0.1f, "round_stone"))),
    PRIMITIVE_PLANKS(new LootTable(MaterialSetRegistry.INSTANCE.commandToMaterialSet("primitive_stones").orElseThrow(), IToolStatsModifier.ToolType.AXE, 2, Map.of(1.0f, "woodpulp"))),
