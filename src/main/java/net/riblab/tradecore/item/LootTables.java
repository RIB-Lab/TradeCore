...
public enum LootTables {
    ...
    PRIMITIVESTONES(new LootTable(Materials.PRIMITIVESTONES.get(), IToolStatsModifier.ToolType.PICKAXE, 0, Map.of(0.2f, TCItems.WIDESTONE.get(), 0.21f, TCItems.TALLSTONE.get()))),
    PRIMITIVESTONES2(new LootTable(Materials.PRIMITIVESTONES.get(), IToolStatsModifier.ToolType.PICKAXE, 1, Map.of(0.1f, TCItems.ROUND_STONE.get()))),
    PRIMITIVEPLANKS(new LootTable(Materials.PRIMITIVEPLANKS.get(), IToolStatsModifier.ToolType.AXE, 2, Map.of(1.0f, TCItems.WOODPULP.get()))),
