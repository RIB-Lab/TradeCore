...
public enum TCItems {
    //原始時代
    PEBBLE(new TCTool(Component.text("小石"), Material.PAPER, "pebble", 1, TCTool.ToolType.AXE, 0, 1.1, -1, List.of())),
    ...
    //原木時代
    WOODEN_AXE(new TCTool(Component.text("木の斧"), Material.WOODEN_AXE, "wooden_axe", 0, TCTool.ToolType.AXE, 2, 1.2, 32, List.of())),
    ...
    STONE_LEGGINGS(new TCEquipment(Component.text("石のレギンス"), Material.CHAINMAIL_LEGGINGS, "stone_leggings", List.of(new ModAddArmor(4), new ModWalkSpeed(-1)), 128, "stone")),
    STONE_BOOTS(new TCEquipment(Component.text("石のブーツ"), Material.CHAINMAIL_BOOTS, "stone_boots", List.of(new ModAddArmor(4), new ModWalkSpeed(-1)), 128, "stone")),
    ...
    GRAVEL_DUST(new TCSellableItem(Component.text("砂利の粉"), Material.GRAVEL, "gravel_dust", 1, 0.05d)),
    FLINT(new TCSellableItem(Component.text("火打石"), Material.FLINT, "flint", 0, 0.05d)),
    METEORIC_IRON_ORE(new TCSellableItem(Component.text("隕鉄鉱石"), Material.IRON_ORE, "meteoric_iron_ore", 1, 0.05d)),
    SAND_DUST(new TCSellableItem(Component.text("粉状の砂"), Material.SAND, "sand_dust", 1, 0.05d)),
    SANDGOLD(new TCSellableItem(Component.text("砂金"), Material.SAND, "sandgold", 2, 0.05d)),
    ASH(new TCSellableItem(Component.text("灰"), Material.SAND, "ash", 3, 0.05d)),
    IRON_SHARD(new TCSellableItem(Component.text("鉄の欠片"), Material.IRON_NUGGET, "iron_shard", 0, 0.05d)),
    GOLD_SHARD(new TCSellableItem(Component.text("金の欠片"), Material.GOLD_NUGGET, "gold_shard", 0, 0.05d)),
