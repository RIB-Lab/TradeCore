...
public enum TCItems {
    ...
    GRAVEL_DUST(new TCSellableItem(Component.text("砂利の粉"), Material.GRAVEL, "gravel_dust", 0, 0.05d)),
    FLINT(new TCSellableItem(Component.text("火打石"), Material.FLINT, "flint", 0, 0.05d)),
    METEORIC_IRON_ORE(new TCSellableItem(Component.text("隕鉄鉱石"), Material.IRON_ORE, "meteoric_iron_ore", 0, 0.05d)),
    SAND_DUST(new TCSellableItem(Component.text("粉状の砂"), Material.SAND, "sand_dust", 0, 0.05d)),
    SANDGOLD(new TCSellableItem(Component.text("砂金"), Material.SAND, "sandgold", 0, 0.05d)),
    ASH(new TCSellableItem(Component.text("灰"), Material.SAND, "ash", 0, 0.05d)),
