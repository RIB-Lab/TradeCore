...
public enum TCItems {
    ...
    //店売り限定
    EMERALD_HELMET(new TCEquipment(Component.text("エメラルドのヘルメット"), Material.CHAINMAIL_HELMET, "emerald_helmet", List.of(new ModReduceCraftCostI(3)), DurabilityTable.STONEAGE,  "emerald")),
    ...
    STONE_AXE(new TCTool(Component.text("石の斧"), Material.STONE_AXE, "stone_axe", 0, TCTool.ToolType.AXE, 3, MiningSpeedTable.STONEMADE, DurabilityTable.STONEAGE, List.of(new ModMonsterSpawnI(Map.of(TCMobs.BASIC_TREANT.get(), 0.05f))))),
    ...
    STONE_PICKAXE(new TCTool(Component.text("石のツルハシ"), Material.STONE_PICKAXE, "stone_pickaxe", 0, TCTool.ToolType.PICKAXE, 1, MiningSpeedTable.STONEMADE, DurabilityTable.STONEAGE, List.of(new ModMonsterSpawnI(Map.of(TCMobs.BASIC_SILVERFISH.get(), 0.01f))))),
    ...
    IRON_AXE(new TCTool(Component.text("鉄の斧"), Material.IRON_AXE, "iron_axe", 0, TCTool.ToolType.AXE, 4, MiningSpeedTable.IRONMADE, DurabilityTable.IRONAGE, List.of(new ModMonsterSpawnI(Map.of(TCMobs.BASIC_TREANT.get(), 0.05f))))),
    ...
    IRON_PICKAXE(new TCTool(Component.text("鉄のツルハシ"), Material.IRON_PICKAXE, "iron_pickaxe", 0, TCTool.ToolType.PICKAXE, 2, MiningSpeedTable.IRONMADE, DurabilityTable.IRONAGE, List.of(new ModMonsterSpawnI(Map.of(TCMobs.BASIC_SILVERFISH.get(), 0.01f))))),
    ...
    GOLDEN_AXE(new TCTool(Component.text("金の斧"), Material.GOLDEN_AXE, "golden_axe", 0, TCTool.ToolType.AXE, 4, MiningSpeedTable.GOLDMADE, DurabilityTable.IRONAGE, List.of(new ModMonsterSpawnI(Map.of(TCMobs.BASIC_TREANT.get(), 0.05f))))),
    ...
    GOLDEN_PICKAXE(new TCTool(Component.text("金のツルハシ"), Material.GOLDEN_PICKAXE, "golden_pickaxe", 0, TCTool.ToolType.PICKAXE, 2, MiningSpeedTable.GOLDMADE, DurabilityTable.IRONAGE, List.of(new ModMonsterSpawnI(Map.of(TCMobs.BASIC_SILVERFISH.get(), 0.01f))))),
