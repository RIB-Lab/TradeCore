...
public enum TCItems {
    ...
    BARK_HELMET(new TCEquipment(Component.text("樹皮のヘルメット"), Material.CHAINMAIL_HELMET, "bark_helmet", List.of(new ModAddArmorI(8)), 32, "bark")),
    BARK_CHESTPLATE(new TCEquipment(Component.text("樹皮のチェストプレート"), Material.CHAINMAIL_CHESTPLATE, "bark_chestplate", List.of(new ModAddArmorI(8)), 32, "bark")),
    ...
    STONE_LEGGINGS(new TCEquipment(Component.text("石のレギンス"), Material.CHAINMAIL_LEGGINGS, "stone_leggings", List.of(new ModAddArmorI(16), new ModWalkSpeedI(-1)), 128, "stone")),
    STONE_BOOTS(new TCEquipment(Component.text("石のブーツ"), Material.CHAINMAIL_BOOTS, "stone_boots", List.of(new ModAddArmorI(16), new ModWalkSpeedI(-1)), 128, "stone")),
