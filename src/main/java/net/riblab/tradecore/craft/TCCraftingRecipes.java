...
public enum TCCraftingRecipes {
    ...
    STICK(new TCCraftingRecipe(Map.of(TCItems.TWIG.get(), 4), TCItems.STICK.get().getItemStack(), 1, 1, RecipeType.MISC)),
    ...
    STONE_COMPONENT(new TCCraftingRecipe(Map.of(TCItems.ROUND_STONE.get(), 10, TCItems.ANDESITE_STONE.get(), 10, TCItems.GRANITE_STONE.get(), 10, TCItems.DIORITE_STONE.get(), 10), TCItems.STONE_COMPONENT.get().getItemStack(), 1, 10, RecipeType.MISC)),
