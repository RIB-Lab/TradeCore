...
public interface IJobData {
    ...
    public enum JobType {
        ...
        public static Argument<JobData.JobType> customJobTypeArgument(String nodeName) {

            return new CustomArgument<JobData.JobType, String>(new StringArgument(nodeName), info -> {
        ...
        public static JobType commandToJOBType(String command) {
            JobType type = Arrays.stream(IJobData.JobType.values()).filter(e -> e.toString().equals(command)).findFirst().orElse(null);
